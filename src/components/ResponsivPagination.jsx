    ...
    <div className=" w-[1440px] h-[1024px] bg-[#E82677] mx-auto p-20">
      {loading ? ( 
        ...
        <div className="bg-white rounded-3xl pt-20">
          ...
          <p className=" w-[593px] text-center ml-[343px] mt-5 mb-14">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur.</p>
